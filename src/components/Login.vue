...
<template>
  ...
  <div :xl="6" :lg="7" class="bg-login">
    <!--标题-->
    <el-row type="flex" class="row-bg row-two" justify="center" align="middle" style="bottom:100px">
    ...
    <!--form表单-->
    <el-row type="flex" class="row-bg card" justify="center" align="bottom" id="form_border">
      <el-col :span="7" class="login-card">
        ...
        <el-form :model="loginForm" :rules="rules" ref="loginForm" label-width="21%" class="loginForm">
          ...
          <el-form-item class="btn-ground">
            ...
            <el-button @click="jump" type="primary">注册</el-button>
            <el-button @click="jump_youke" type="primary">游客登陆</el-button>
          </el-form-item>
        </el-form>
      </el-col>
    </el-row>
