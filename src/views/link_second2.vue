<template>
  <div>
    <div class="con">
      <div class="word">
        <p style="text-align: center;font-size: 32px;"><strong>中共中央国务院关于表彰全国劳动模范和先进工作者的决定</strong></p>
        ...
        <p>希望获得全国劳动模范和先进工作者称号的同志，不忘初心、牢记使命，珍惜荣誉、继续拼搏，用干劲、闯劲、钻劲鼓舞更多的人，激励广大劳动群众争做新时代的奋斗者。
        </p>
        <p>
