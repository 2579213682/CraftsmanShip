...
<template>
  <div>
    ...
    <div class="header clearfix w">
      ...
      <div class="top_dyw407" id="char">
        <img src="https://p2.img.cctvpic.com/photoworkspace/2020/04/10/2020041014542784760.jpg">
        <div class="text">
          <h4>小伙子大工匠</h4>
          <p>作品由黑龙江省委组织部、牡丹江市委组织部、黑龙江林业职业技术学院委员会报送。</p>
          <span>来源：共产党员网</span>
        </div>
      </div>
      <!-- 选集标题 -->
  ...
  padding: 0 10px;  line-height: 72px; margin-top: 40px;">
        ...
        <!-- 分页器 -->
        <div style="position: absolute;;margin:0 auto;margin-left: -100px;left: 50%;margin-top: 80px;top: 50%;">
...
export default {
  data () {
    return {
      // 第一个li列表序列数据
      data: [ // 模拟数据
        { id: 1, name: '小伙子大工匠', href: 'https://www.12371.cn/2020/04/10/VIDE1586500441215648.shtml', imgurl: 'https://p1.img.cctvpic.com/fmspic/2019/12/26/98a5dd2185eeceb0654761f34376f495-300.jpg' }
      ],
      totalPage: [], // 所有分页的数据
      pageSize: 6, // 每页显示数量
