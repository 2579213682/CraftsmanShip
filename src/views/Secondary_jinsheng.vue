...
<template>
  <div>
    ...
    <div class="header clearfix w">
      ...
      <div class="top_dyw407" id="char">
        <img src="https://p4.img.cctvpic.com/fmspic/vms/image/2013/09/10/VSET_1378797235742346.jpg">
        <div class="text">
          <h4>微型党课</h4>
          <p>共产党员电视栏目中的微型党课版块，主要内容是宣传党的基本理论、党的基本知识、党的历史、党的路线方针政策和形势任务，开展法律法规和党性党风党纪宣传教育。</p>
        </div>
      </div>
      <!-- 选集标题 -->
  ...
  padding: 0 10px;  line-height: 72px; margin-top: 40px;">
        ...
        <!-- 分页器 -->
        <div style="position: absolute;;margin:0 auto;margin-left: -100px;left: 50%;margin-top: 340px;top: 50%;">
...
export default {
  data () {
    return {
      // 第一个li列表序列数据
      data: [ // 模拟数据
        { id: 1, name: '《党史故事精粹》（第53集）——绝命后卫师20230512', title: '《党史故事精粹》（第53集）——绝命后卫师20230512', href: 'https://dslm.12371.cn/2023/05/12/VIDE1683883447827606.shtml', imgurl: 'https://p3.img.cctvpic.com/fmspic/2023/05/12/9bc351411d94413bb7d13132986a7b30-1.jpg' },
        { id: 2, name: '系列节目《党史故事精粹》（第52集）——永恒的青春20230505', title: '系列节目《党史故事精粹》（第52集）——永恒的青春20230505', href: 'https://dslm.12371.cn/2023/05/05/VIDE1683270245843519.shtml', imgurl: 'https://p5.img.cctvpic.com/fmspic/2023/05/05/67c667767c6e4c20a72ec5faee1a9190-180.jpg' },
        { id: 3, name: '系列节目《乡村振兴进行时》（第15集）——江苏徐州马庄村：文化铺就振...', title: '系列节目《乡村振兴进行时》（第15集）——江苏徐州马庄村：文化铺就振兴路20230428', href: 'https://dslm.12371.cn/2023/04/28/VIDE1682669527863117.shtml', imgurl: 'https://p5.img.cctvpic.com/fmspic/2023/04/28/5d8312894feb445b9d1fcb5d9f555af3-1.jpg' },
        { id: 4, name: '系列节目《乡村振兴进行时》（第14集）——辽宁大连英杰村：耕海牧渔 ...', title: '系列节目《乡村振兴进行时》（第14集）——辽宁大连英杰村：耕海牧渔 踏浪而歌', href: 'https://dslm.12371.cn/2023/04/21/VIDE1682078651614652.shtml', imgurl: 'https://p5.img.cctvpic.com/fmspic/2023/04/21/49e49b54d46149f3ad89ea7ff53ddad7-1.jpg' },
        { id: 5, name: '系列节目《乡村振兴进行时》（第13集）——云南曲靖上村乡：小山村育出...', title: '系列节目《乡村振兴进行时》（第13集）——云南曲靖上村乡：小山村育出全球顶奢食材', href: 'https://dslm.12371.cn/2023/04/17/VIDE1681693219021151.shtml ', imgurl: 'https://p4.img.cctvpic.com/fmspic/2023/04/14/3945f90dd8184eac913e88137a1236a0-1.jpg' },
        { id: 6, name: '系列节目《乡村振兴进行时》（第12集）——山东威海大水泊镇：村里来了...', title: '系列节目《乡村振兴进行时》（第12集）——山东威海大水泊镇：村里来了“首席专家”20230407', href: 'https://dslm.12371.cn/2023/04/07/VIDE1680849310430968.shtml', imgurl: 'https://p4.img.cctvpic.com/fmspic/2023/04/07/52920bc5eae743aba91d6fe18d2bef41-1.jpg' }
